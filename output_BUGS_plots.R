...
load(here::here("code", "data output", folder_nm, "BUGSoutput.RData"))
load(here::here("code", "data output", folder_nm, "jags_dat_input.RData"))
...
# raw data
points(jags_dat_input$time_b, jags_dat_input$X_d/jags_dat_input$Nb,
...
# raw data
# points(jags_dat_input$time_b, jags_dat_input$X_sf/jags_dat_input$Nb,
#        pch = jags_dat_input$studyid_b)
